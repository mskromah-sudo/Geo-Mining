      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="mb-16 max-w-3xl">
          ...
          <p className="text-slate-600 leading-relaxed">
            Geo Mining & Environmental Consultancy operates as a parent holding
            and strategic company, overseeing two specialized subsidiaries that
            together deliver integrated solutions from exploration to
            production.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Parent Company */}
          <div className="bg-[#2d6130] text-white p-8 rounded-sm relative overflow-hidden group">
            ...
            <div className="relative z-10">
              ...
              <p className="text-slate-300 text-sm mb-6 leading-relaxed">
                Provides strategic leadership, technical oversight, and
                environmental governance. Serves as the foundation for all
                subsidiary operations.
              </p>
              <ul className="space-y-2 text-sm text-slate-400">
                <li className="flex items-start gap-2">
                  <span className="text-amber-500 mt-1">▪</span> Geological
                  consultancy & Feasibility
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-500 mt-1">▪</span> Environmental &
                  Social Impact (ESIA)
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-500 mt-1">▪</span> Regulatory
                  Compliance (EPA)
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-amber-500 mt-1">▪</span> ESG Policy &
                  Community Relations
                </li>
              </ul>
            </div>
