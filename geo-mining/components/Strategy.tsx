      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-slate-400">
            The Group’s structure allows for a seamless and efficient approach
            to mining development, reducing project risk and enhancing
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
          ...
          <div className="relative group">
            <div className="flex flex-col items-center text-center p-8 rounded bg-slate-800/50 hover:bg-slate-800 transition-colors border border-transparent hover:border-amber-500/30 h-full">
              <div className="text-amber-500 text-4xl font-bold mb-4 opacity-20 group-hover:opacity-100 transition-opacity">
                01
              </div>
              ...
              <p className="text-amber-500 text-xs uppercase tracking-wider mb-4">
                Geo Mining & Environmental Consultancy
              </p>
              <p className="text-sm text-slate-400 leading-relaxed">
                Environmental and geological studies, ensuring regulatory
                compliance and foundational planning.
              </p>
            </div>
            {/* Arrow Desktop */}
          ...
          <div className="relative group">
            <div className="flex flex-col items-center text-center p-8 rounded bg-slate-800/50 hover:bg-slate-800 transition-colors border border-transparent hover:border-amber-500/30 h-full">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                Mineral discovery, evaluation, and resource definition to
          ...
          <div className="relative group">
            <div className="flex flex-col items-center text-center p-8 rounded bg-slate-800/50 hover:bg-slate-800 transition-colors border border-transparent hover:border-amber-500/30 h-full">
              ...
              <p className="text-sm text-slate-400 leading-relaxed">
                Mine development and operational execution, translating
        ...
        <div className="mt-20 bg-amber-500 rounded-sm p-8 md:p-12 flex flex-col md:flex-row items-center justify-between">
          <div className="mb-6 md:mb-0 text-center md:text-left">
            ...
            <p className="text-slate-800">
              For consultancy services or general inquiries.
            </p>
          </div>
