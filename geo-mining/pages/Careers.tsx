      ...
      <div className="relative bg-gradient-to-br from-[#2d6130] to-[#1a3d1c] text-white py-24 md:py-32 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 md:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-light mb-6">
            Build Your{' '}
            <strong className="font-extrabold text-amber-400">Career</strong>{' '}
            With Us
          </h1>
          <p className="text-xl text-slate-100 max-w-3xl mx-auto leading-relaxed">
            Join a team committed to responsible mining, environmental
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto leading-relaxed">
              ...
              innovation flourishes, and every team member contributes to
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              Fill out the form below to apply for a position. We'll review your
              ...
              >
                ...
                >
                  ...
                  {expandedFaq === index ? (
                    ...
                    <ChevronDown
                      className="text-[#2d6130] shrink-0"
                      size={20}
                    />
                  )}
                </button>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-12">
            ...
            <h3 className="text-3xl md:text-4xl font-light text-slate-900 mb-6">
              What's Happening at{' '}
              <strong className="font-bold">GeoMining</strong>
            </h3>
          </div>
            ...
            {[
              {
                ...
                date: 'December 2025',
                description:
                  'GeoMining announces major exploration initiative in northern Liberia',
              },
              {
                title: 'Community Development Award',
                date: 'November 2025',
                description:
                  'Recognized for outstanding CSR programs and local empowerment',
              },
              {
                title: 'Graduate Trainee Program 2025',
                date: 'October 2025',
                description:
                  'Applications now open for our annual graduate development program',
              },
            ].map((news, i) => (
              <div
                key={i}
      ...
      <section className="py-20 bg-slate-900 text-white">
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
          <h3 className="text-3xl font-light mb-6">
            ...
            <strong className="font-bold text-amber-400">Recruitment?</strong>
          </h3>
