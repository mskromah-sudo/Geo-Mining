    ...
    <div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center mb-16">
          <h2 className="text-3xl font-light text-slate-900 mb-6">Our Operating Companies</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 space-y-16">
          ...
          <div id="stonecrest-resource" className="flex flex-col md:flex-row gap-12 items-start border-l-4 border-amber-500 pl-6 md:pl-12 py-4 scroll-mt-24">
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-6">
                 ...
                 <div>
                   <h3 className="text-3xl font-bold text-slate-900">StoneCrest Resource Limited</h3>
                   <span className="text-amber-600 font-bold uppercase text-xs tracking-wider">Exploration & Resource Development</span>
                 </div>
              </div>
              ...
              <div className="bg-slate-50 p-6 rounded-sm border border-slate-100">
                <h4 className="font-bold text-slate-900 mb-4 border-b border-slate-200 pb-2">Core Activities</h4>
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-slate-700">
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-amber-500 rounded-full"></div> Geological mapping and mineral exploration</li>
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-amber-500 rounded-full"></div> Sampling, data analysis, and interpretation</li>
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-amber-500 rounded-full"></div> Resource estimation and technical reporting</li>
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-amber-500 rounded-full"></div> Early project development and evaluation</li>
                </ul>
              </div>
          ...
          <div id="stonecrest-mining" className="flex flex-col md:flex-row gap-12 items-start border-l-4 border-slate-900 pl-6 md:pl-12 py-4 scroll-mt-24">
            <div className="flex-1">
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-6 mb-6">
                 {/* Logo Area - Replace src with actual file path */}
                 ...
                 <div>
                   <h3 className="text-3xl font-bold text-slate-900">StoneCrest Mining Corporation</h3>
                   <span className="text-amber-600 font-bold uppercase text-xs tracking-wider">Mining Operations & Production</span>
                 </div>
              </div>
              <p className="text-slate-600 mb-6 leading-relaxed text-lg">
               ...
               <div className="bg-slate-50 p-6 rounded-sm border border-slate-100">
                <h4 className="font-bold text-slate-900 mb-4 border-b border-slate-200 pb-2">Core Activities</h4>
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm text-slate-700">
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-slate-900 rounded-full"></div> Mine development and operational planning</li>
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-slate-900 rounded-full"></div> Mining and processing operations</li>
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-slate-900 rounded-full"></div> Health, safety, and environmental management</li>
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-slate-900 rounded-full"></div> Implementation of Environmental Management Plans</li>
                  <li className="flex items-center gap-2"><div className="w-1.5 h-1.5 bg-slate-900 rounded-full"></div> Mine rehabilitation and closure planning</li>
                </ul>
              </div>
               <p className="text-sm text-slate-500 mt-4 italic">
