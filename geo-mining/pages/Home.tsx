...
const Home: React.FC = () => {
  ...
  return (
    <div>
      ...
      {/* Intro Section */}
      <section id="overview" className="py-20 max-w-4xl mx-auto px-4 md:px-8 text-center scroll-mt-24">
        <h2 className="text-3xl font-light text-slate-900 mb-6">About The Group</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-16">
          <div>
            <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-amber-500 rounded-sm text-slate-900"><Globe size={20} /></div>
          ...
          <div>
             <div className="flex items-center gap-3 mb-4">
              <div className="p-2 bg-amber-500 rounded-sm text-slate-900"><Briefcase size={20} /></div>
      ...
      {/* Purpose & Values */}
      <section id="values" className="py-20 bg-slate-900 text-white scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="mb-12 max-w-3xl">
            <h2 className="text-amber-500 font-bold uppercase tracking-widest text-sm mb-3">Core Principles</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              <div key={i} className="bg-slate-800 p-6 rounded-sm border-t-4 border-amber-500 hover:bg-slate-700 transition-colors">
      ...
      <section id="presence" className="py-20 bg-white scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col md:flex-row items-center gap-12">
          <div className="flex-1">
            <h3 className="text-2xl font-bold text-slate-900 mb-4">Our Regional Presence</h3>
            <p className="text-slate-600 leading-relaxed mb-6">
          ...
          <div className="flex-1">
             <img src="https://picsum.photos/800/400?grayscale&blur=1" alt="Regional Map" className="w-full h-auto rounded-sm shadow-lg grayscale hover:grayscale-0 transition-all" />
          </div>
        </div>
      </section>
    </div>
